...
var
  sBit : TMachineType;
begin
  if Trim(edFilePath.Text) <> '' then begin

    sBit := GetLibMachineType(edFilePath.text);
    case sBit of
          mtUnknown: lbResult.Caption := 'UNKNOWN' ;
          mt32Bit: lbResult.Caption := '32' ;
          mt64Bit: lbResult.Caption := '64' ;
          mtOther: lbResult.Caption := 'OTHER' ;
    end;
  end;//if
end;
