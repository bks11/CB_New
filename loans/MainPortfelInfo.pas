...
Begin
  ...
  MainForm.MainInfoSumLoansEcv.Caption := 'СУММА В ЭКВИВАЛЕНТЕ - '+ FloatToStrF(EqvLoan,ffGeneral,8,2);
  ...
  MainForm.MainInfoSumZadEcv.Caption := 'СУММА В ЭКВИВАЛЕНТЕ - '+ FloatToStrF(EqvZad,ffGeneral,8,2);
  ...
  MainForm.MainInfoSumprosEcv.Caption := 'СУММА В ЭКВИВАЛЕНТЕ - '+ FloatToStrF(EqvProsroch,ffGeneral,8,2);
  ...
  MainForm.MainInfoSumProcEcv.Caption := 'СУММА В ЭКВИВАЛЕНТЕ - '+ FloatToStrF(EqvPercent,ffGeneral,8,2);
