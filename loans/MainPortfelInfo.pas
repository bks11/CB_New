...
Begin
  ...
  MainForm.MainInfoPortfelSumRUR.Caption:='В RUR - ' + FloatToStrF(SummRUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumUSD.Caption:='В USD - ' + FloatToStrF(SummUSD,ffNumber,12,2);
  MainForm.MainInfoPortfelSumEUR.Caption:='В EUR - ' + FloatToStrF(SummEUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumUAH.Caption:='В UAH - ' + FloatToStrF(SummUAH,ffNumber,12,2);
  MainForm.MainInfoSumLoansEcv.Caption := 'ЭКВ. - '+ FloatToStrF(EqvLoan,ffNumber,12,2);


  MainForm.MainInfoPortfelSumZRUR.Caption:='В RUR - ' + FloatToStrF(SummZRUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumZUSD.Caption:='В USD - ' + FloatToStrF(SummZUSD,ffNumber,12,2);
  MainForm.MainInfoPortfelSumZEUR.Caption:='В EUR - ' + FloatToStrF(SummZEUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumZUAH.Caption:='В UAH - ' + FloatToStrF(SummZUAH,ffNumber,12,2);
  MainForm.MainInfoSumZadEcv.Caption := 'ЭКВ. - '+ FloatToStrF(EqvZad,ffNumber,12,2);

  MainForm.MainInfoPortfelSumTRUR.Caption:='В RUR - ' + FloatToStrF(SummTRUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumTUSD.Caption:='В USD - ' + FloatToStrF(SummTUSD,ffNumber,12,2);
  MainForm.MainInfoPortfelSumTEUR.Caption:='В EUR - ' + FloatToStrF(SummTEUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumTUAH.Caption:='В UAH - ' + FloatToStrF(SummTUAH,ffNumber,12,2);
  MainForm.MainInfoSumprosEcv.Caption := 'ЭКВ. - '+ FloatToStrF(EqvProsroch,ffNumber,12,2);

  MainForm.MainInfoPortfelSumPRUR.Caption:='В RUR - ' + FloatToStrF(SummPRUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumPUSD.Caption:='В USD - ' + FloatToStrF(SummPUSD,ffNumber,12,2);
  MainForm.MainInfoPortfelSumPEUR.Caption:='В EUR - ' + FloatToStrF(SummPEUR,ffNumber,12,2);
  MainForm.MainInfoPortfelSumPUAH.Caption:='В UAH - ' + FloatToStrF(SummPUAH,ffNumber,12,2);
  MainForm.MainInfoSumProcEcv.Caption := 'ЭКВ. - '+ FloatToStrF(EqvPercent,ffNumber,12,2);
